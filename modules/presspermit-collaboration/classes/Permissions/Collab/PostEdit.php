...
class PostEdit
{
    public static function defaultPrivacyWorkaround()
    {
        ...
        && presspermit()->getTypeOption('default_privacy', sanitize_key($_POST['post_type']))
        ) {
            ...
            && !in_array($_POST['hidden_post_status'], $stati, true)
                ...
                $_POST['post_status'] = sanitize_key($_POST['hidden_post_status']);
                $_REQUEST['post_status'] = sanitize_key($_REQUEST['hidden_post_status']);

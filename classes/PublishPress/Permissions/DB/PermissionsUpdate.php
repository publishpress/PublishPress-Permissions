...
class PermissionsUpdate
{
    ...
    private static function insertExceptions(
        ...
        if (
            $optimized_insertions = (('post' != $via_item_source) || (!empty($propagate_post_types) && (1 == count($propagate_post_types))))
    ...
    public static function deleteExceptions($agent_ids, $agent_type = 'pp_group')
    {
        ...
        if (
            $exc_ids = $wpdb->get_col($wpdb->prepare(

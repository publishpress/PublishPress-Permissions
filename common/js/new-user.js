...
var presspermitAjaxUI=function(op,handler){var data={'pp_ajax_user_ui':op};$.ajax({url:ppUser.ajaxurl,data:data,dataType:"html",success:handler,error:presspermitAjaxUIFailure});}
